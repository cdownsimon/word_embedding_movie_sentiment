...
# decode the index array
def decode_index(x, index_word):
    return ' '.join([index_word[i] for i in x])
...
def predict_sentiment(review, word_index, max_sequences_length, model):
    ...
    # mark the non-common word as <UNK>
    line = [i if i < 10000 else 2 for i in line]
